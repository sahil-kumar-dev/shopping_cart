		...
		<div className="flex h-[250px] border-b-2 border-solid border-gray-400 my-8">
			...
			<div className="w-3/5 h-full flex flex-col justify-between">
				<div className=" ">
					...
					<p className='text-sm text-gray-600 font-semibold'>{description.split(' ').splice(0, 20).join(' ') + "..."}</p>

				</div>
				<div className="flex justify-between w-full px-4 py-2">
					<p className='text-green-600 font-bold text-lg'>₹{price}</p>
					<button className="text-red-600 h-12 w-12 bg-red-300 rounded-full flex items-center justify-center text-2xl hover:bg-red-400" onClick={removeFromCart}>
						<AiFillDelete />
					</button>
				</div>
			</div>
